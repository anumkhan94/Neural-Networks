# Khan, Anum Farrukh
#This assignment implements a class which can be used to create multi-layer neural networks using Tensorflow(without keras).
...
class CNN(object):
    ...
    def remove_last_layer(self,layer_number=None,layer_name=""):
        """
